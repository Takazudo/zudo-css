...
<div class="theme-demo__col">
  <h3 class="theme-demo__title">Palette (Tier 1)</h3>
  <div class="mapping">
...
<div class="full-demo__result">
  ...
  --palette-blue-700: oklch(42% 0.16 250);
  --palette-green-100: oklch(94% 0.06 150);
  --palette-green-600: oklch(50% 0.16 150);
  ...
  --theme-muted:        var(--palette-gray-500);
  --theme-border:       var(--palette-gray-300);
  --theme-success:      var(--palette-green-600);
...
<div class="min-h-screen bg-theme-bg p-5 font-[system-ui,sans-serif]">
  <header class="bg-theme-fg rounded-xl px-5 py-3 flex items-center justify-between mb-4">
    ...
    <nav class="flex gap-4">
      <a class="text-theme-accent-fg/70 text-sm hover:text-theme-accent-fg cursor-pointer">Dashboard</a>
      <a class="text-theme-accent-fg/70 text-sm hover:text-theme-accent-fg cursor-pointer">Settings</a>
    </nav>
  </header>
  ...
  theme: {
    extend: {
      colors: {
        ...
        't-accent-fg': 'var(--theme-accent-fg)',
        't-muted': 'var(--theme-muted)',
...
<div class="grid grid-cols-3 min-h-screen font-[system-ui,sans-serif]">
  <div class="theme-corporate bg-t-bg p-4">
    <h4 class="text-[11px] uppercase tracking-wider font-bold text-t-muted mb-3">Corporate</h4>
    <div class="bg-t-surface border border-t-border rounded-xl p-4">
      <h3 class="font-bold text-t-fg mb-1">Dashboard</h3>
      <p class="text-sm text-t-muted mb-3">3 tasks pending</p>
      <div class="bg-t-bg border border-t-border rounded-lg p-3 mb-3 text-center">
        <div class="text-xl font-bold text-t-fg">94%</div>
        <div class="text-[11px] text-t-muted">Score</div>
      </div>
      <button class="w-full bg-t-accent text-t-accent-fg py-2 rounded-lg text-sm font-semibold">
        View
      </button>
    </div>
  </div>

  <div class="theme-warm bg-t-bg p-4">
    <h4 class="text-[11px] uppercase tracking-wider font-bold text-t-muted mb-3">Creative</h4>
    <div class="bg-t-surface border border-t-border rounded-xl p-4">
      <h3 class="font-bold text-t-fg mb-1">Dashboard</h3>
      <p class="text-sm text-t-muted mb-3">3 tasks pending</p>
      <div class="bg-t-bg border border-t-border rounded-lg p-3 mb-3 text-center">
  ...
  <div class="theme-night bg-t-bg p-4">
    <h4 class="text-[11px] uppercase tracking-wider font-bold text-t-muted mb-3">Night</h4>
    <div class="bg-t-surface border border-t-border rounded-xl p-4">
      <h3 class="font-bold text-t-fg mb-1">Dashboard</h3>
      <p class="text-sm text-t-muted mb-3">3 tasks pending</p>
      <div class="bg-t-bg border border-t-border rounded-lg p-3 mb-3 text-center">
