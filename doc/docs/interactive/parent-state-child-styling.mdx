...
<CssPreview
  title="Card — Hover to see coordinated child changes"
  html={`
<div class="demo">
  <div class="card">
    <div class="card__icon">→</div>
    <h3 class="card__title">Hover this card</h3>
    <p class="card__desc">The icon shifts, the title changes color, and the background transitions — all from a single parent :hover.</p>
  </div>
  <div class="card">
    <div class="card__icon">→</div>
...
.accordion__item:has(.accordion__trigger:checked) .accordion__body > p {
  padding: 0 1rem 1rem;
}
  `}
/>
...
| `group` + `group-focus:opacity-100` | `.parent:focus-within .child { opacity: 1; }` |
