...
|---|---|
| Have a build tool, can't change HTML | [CSS Modules](/methodology/css-modules-strategy) or Tailwind `@apply` |
| No build tool, global CSS only | [BEM naming convention](/methodology/bem-strategy) |
