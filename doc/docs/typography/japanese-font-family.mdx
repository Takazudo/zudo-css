...
4. **Web font size**: A Japanese character set contains thousands of glyphs. Noto Sans JP weighs ~9MB, Noto Serif JP ~10MB — far too large for practical web font usage without subsetting or a CSS variable font strategy.
