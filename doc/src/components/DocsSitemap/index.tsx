...
function renderCategoryNavData(catData: CategoryData, docsBaseUrl: string): ReactNode {
  return (
    <Fragment>
...
function renderAutogenerated(dirName: string, docsBaseUrl: string): ReactNode {
  if (dirName === '.') {
